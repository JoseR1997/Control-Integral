        ...
        {[1, 2,3,4].map((index) => (
          <div key={index} className='bg-white border border-gray-200 p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300'>
            <div className='flex flex-col space-y-2'>
              <p className="text-xs text-gray-500 uppercase tracking-wider mb-2">Caso Reciente</p>
              <p><span className="font-medium text-gray-700">Proceso:</span> <span className="text-gray-600">Detalles del proceso</span></p>
              <p><span className="font-medium text-gray-700">Cliente:</span> <span className="text-gray-600">Nombre del cliente</span></p>
